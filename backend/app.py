...
# Primeiro tenta o ID salvo no banco.
# Porém, se ele estiver cancelado/inativo,
# NÃO considera isso como definitivo.
if subscription_id:
    ...
    try:
        ...
        if assinatura.get("status") not in active_statuses:
...
# Se o ID salvo não estiver ativo,
# procura uma assinatura ativa pelo e-mail.
if not assinatura:
